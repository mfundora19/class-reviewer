...
(function () {
  ...
  function viewDashboard(root) {
    ...
    var termText = 'reviewapp v1.2.1 — ' + (cert ? cert.name + ' · ' : '') + compactNumber(counts.questions) + ' questions · ' +
  ...
  function buildMarkdownReport(certId) {
    ...
    L.push('---');
    L.push('');
    L.push('_Generated by ReviewApp v1.2.1 — offline study analytics._');
    L.push('');
...
/* ── Permissions exercise UI ───────────────────────────── */
  ...
  function viewSettings(root) {
    ...
    about.appendChild(el('p', { text: 'ReviewApp v1.2.1 — offline study hub for CompTIA Linux+ and Network+.' }));
