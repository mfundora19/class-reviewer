...
(function () {
  ...
  function viewDashboard(root) {
    ...
    var termText = 'reviewapp v1.1.0 — ' + (cert ? cert.name + ' · ' : '') + compactNumber(counts.questions) + ' questions · ' +
  ...
  function buildMarkdownReport(certId) {
    ...
    L.push('---');
    L.push('');
    L.push('_Generated by ReviewApp v1.1.0 — offline study analytics._');
    L.push('');
  ...
  function buildPermExerciseSection() {
    ...
    function renderConfig() {
      ...
      body.appendChild(el('div', { className: 'label-upper mb-1', text: 'Exercise types' }));
      ...
      body.appendChild(el('p', { className: 'text-muted', style: { fontSize: '0.8rem' },
        text: 'Off = classic conversions only. On = exercises may include setuid/setgid/sticky.' }));
      ...
      row.appendChild(el('button', {
        ...
        onClick: function () {
          ...
          var cfg = { includeSetuid: false, includeSetgid: false, includeSticky: false, types: types };
  ...
  function viewSettings(root) {
    ...
    about.appendChild(el('p', { text: 'ReviewApp v1.1.0 — offline study hub for CompTIA Linux+ and Network+.' }));
